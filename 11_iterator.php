...
/**
 * https://refactoring.guru/ru/design-patterns/iterator/php/example#example-1
 *
 * Пример из реальной жизни
 *
 * Так как PHP уже имеет встроенный интерфейс Итератора, который предоставляет удобную интеграцию с
 * циклами foreach, очень легко создать собственные итераторы для обхода практически любой мыслимой
 * структуры данных.
