...
/**
 * https://refactoring.guru/ru/design-patterns/template-method/php/example#example-1
 *
 * Пример из реальной жизни
 *
 * В этом примере Шаблонный метод определяет общую схему алгоритма отправки сообщений в
 * социальных сетях. Каждый подкласс представляет отдельную социальную сеть и реализует
